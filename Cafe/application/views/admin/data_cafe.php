		...
		<tr>
		 ...
		 foreach($cafe as $cafe): ?>
		 	<tr>
		 		...
		 		<td><?php echo anchor('admin/data_cafe/edit/' .$cafe->id_cafe, '<div class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></div>')?>
		 		<?php echo anchor('admin/data_cafe/hapus/' .$cafe->id_cafe, '<div class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></div>')?></td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?php echo base_url(). 'index.php/admin/data_cafe/tambah_aksi';?>" method="post" enctype="multipart/form-data">
        	...
        	<div class="form-group">
        		...
        		<input type="number" name="meja" class="form-control">
        	</div>
        	<div class="form-group">
        		<label>Alamat</label>
