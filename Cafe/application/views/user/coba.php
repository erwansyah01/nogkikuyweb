		...
		<tr>
		 ...
		 foreach($cafe as $cafe): ?>
		 	<tr>
		 		...
		 		<td><?php echo anchor('user/data_cafe/detail/' .$cafe->id_cafe, '<div class="btn btn-success btn-sm"><i class="fas fa-search-plus"></i></div>')?></td>
		 		<td><?php echo anchor('user/data_cafe/edit/' .$cafe->id_cafe, '<div class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></div>')?> </td>
		 		<td><?php echo anchor('user/data_cafe/hapus/' .$cafe->id_cafe, '<div class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></div>')?></td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?php echo base_url(). 'index.php/user/data_cafe/tambah_menu';?>" method="post" enctype="multipart/form-data">
